...
[CreateAssetMenu(menuName = "Player Properties")] //Create a new playerData object by right clicking in the Project Menu then Create/Player/Player Data and drag onto the player
public class PlayerProp : ScriptableObject
{
	...
	public float runLerpAmount; //Target speed we want the player to reach.
